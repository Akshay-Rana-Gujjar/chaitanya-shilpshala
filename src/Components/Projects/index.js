    ...
    return(
        <>
            ...
            <Swiper navigation autoplay effect="fade" pagination={{ clickable: true }}>
                <SwiperSlide><img src={projects1} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects7} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects2} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects6} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects3} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects5} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects4} alt="image" className="project-imgs"/></SwiperSlide>
                <SwiperSlide><img src={projects8} alt="image" className="project-imgs"/></SwiperSlide>
            </Swiper>
            <br/><br/>
            </>
    )
