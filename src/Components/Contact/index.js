    ...
    <>
      <div className="contact-div" id="contact">
        <div className="mx-auto">
          <h4>CONTACT US</h4>
          <div className="row">
            <div className="col-lg-6 col-md-12" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="300">
            ...
            <div className="col-lg-6 col-md-12 mt-5 mt-sm-0"  data-aos="slide-up" data-aos-duration="1000" data-aos-delay="300">
              <form
                action=""
                className="mx-auto"
                autoComplete="off"
