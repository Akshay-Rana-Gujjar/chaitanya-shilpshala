    ...
    <div className="about" id="about">
      <div className="about-section">
        ...
        <div className="container pb-5">
          <div className="row d-flex align-items-center border glass-bg rounded" data-aos="fade" data-aos-duration="1000">
          ...
          <div className="row mt-5 d-flex align-items-center border glass-bg rounded" data-aos="fade" data-aos-duration="1000">
